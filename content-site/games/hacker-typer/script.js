...
function handleKeyPress(e) {
  ...
  while (
    currentIdx < targetCode.length &&
    targetCode[currentIdx] === ' ' &&
    (currentIdx === 0 || targetCode[currentIdx - 1] === '\n')
  ) {
...
function finishGame(success) {
  ...
  if (success) {
    ...
    gameOverDesc.textContent =
      'Your signature was identified and quarantined by network administrators.';
    synth.playError();
  }
