...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const DEFAULT_MEDS = [
    {
      ...
      frequency: 'Daily',
      time: '08:00',
      log: { Morning: '08:05', Afternoon: '', Evening: '', Night: '' },
    },
    {
      id: '2',
      name: 'Metoprolol',
      ...
      time: '08:00, 20:00',
      log: { Morning: '08:10', Afternoon: '', Evening: '', Night: '' },
    },
    {
      id: '3',
      name: 'Lisinopril',
  ...
  window.CSAITool.init({
    ...
    emptyMessage:
      'Please list at least one medication in the administration log to perform the audit.',
    collectInput: () => {
      if (meds.length === 0) return '';
      const medsString = meds
        .map(med => {
          const administrations =
            Object.entries(med.log)
              .filter(([_, time]) => time !== '')
      ...
      const auditLabel =
        auditTypeVal === 'handoff-summary' ? 'Caregiver Handoff Summary' : 'Drug Safety Audit';
