  ...
  const DEFAULT_LOGS = [
    {
      id: '1',
      time: '14:30',
      antecedent: 'Staff tried to guide resident to the shower.',
      behavior: 'Resident became agitated, raised voice, and pushed hands away.',
      consequence:
        'Staff backed off, offered a warm towel and cup of tea, re-approached 20 mins later successfully.',
    },
    {
      id: '2',
      time: '18:15',
      antecedent: 'Shadowing / sundowning started around dinner time.',
      behavior:
        'Resident kept pacing hall, checking doors, saying "I need to go home to make dinner for my kids."',
      consequence:
        'Validated feelings about her children, guided her to the kitchen to help fold napkins.',
    },
  ];
