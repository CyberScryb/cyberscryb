...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const inputs = [stateEl, incomeAEl, incomeBEl, childrenEl, custodyEl, nightsEl, childcareEl, insuranceEl];
    ...
    function calculateBaseline() {
        ...
        if (localResultObligationEl) localResultObligationEl.textContent = `$${Math.round(baseObligation).toLocaleString()}`;
        if (localResultFinalEl) localResultFinalEl.textContent = `$${Math.round(finalSupport).toLocaleString()}/mo`;
