...
KITS.append(dict(
    ...
    title="Job-Loss Mortgage Forbearance Kit — Sample Letter + Packet (2026)",
    description="Full sample forbearance letter after a layoff, attachment checklist, what not to say, and what happens after you send it. Free to copy.",
    path="/kits/mortgage-forbearance-job-loss-kit/",
    date="2026-07-21",
    read="12 min read",
    eyebrow="Hardship kit · Mortgage",
    h1="Job-loss mortgage forbearance kit",
    lede="You just lost income. You still have a mortgage. This kit gives you a complete, one-page forbearance letter you can adapt today — plus the packet that makes servicers actually open a review.",
    faq=[
...
KITS.append(dict(
    ...
    title="Creditor Hardship Letter After Pay Cut — Sample + Checklist (2026)",
    description="Sample hardship letter for credit cards and personal loans after a pay cut or job loss. What to ask for, what to attach, what not to say.",
    path="/kits/creditor-hardship-pay-cut-kit/",
    date="2026-07-21",
    read="9 min read",
    eyebrow="Hardship kit · Credit cards & loans",
    h1="Creditor hardship letter after a pay cut",
    lede="Cards and personal loans do not use mortgage loss-mitigation rules — but a clear, short hardship letter still opens hardship, settlement, or payment-plan conversations. Here is a usable sample and the packet that backs it up.",
    faq=[
...
KITS.append(dict(
    ...
    title="Unemployment Misconduct Denial Appeal Kit — Sample Letter (2026)",
    description="Sample unemployment appeal letter when denied for misconduct, evidence checklist, what not to write, and hearing prep basics. Free template.",
    path="/kits/unemployment-misconduct-appeal-kit/",
    date="2026-07-21",
    read="11 min read",
    eyebrow="Appeal kit · Unemployment",
    h1="Unemployment denial for misconduct — appeal kit",
    lede="The agency took the employer’s side on “misconduct.” That word has a legal meaning — a single mistake or performance issue is often not enough. This kit gives you a focused appeal letter, evidence list, and hearing mindset.",
    faq=[
...
KITS.append(dict(
    ...
    title="Unemployment Appeal Hearing Packet Checklist (2026)",
    description="What to prepare for an unemployment appeal hearing: documents folder, timeline, witness notes, day-of script, and common traps.",
    path="/kits/unemployment-hearing-packet/",
    date="2026-07-21",
    read="8 min read",
    eyebrow="Appeal kit · Hearing",
    h1="Unemployment hearing packet checklist",
    lede="You filed the appeal. Now the hearing will decide it. This is the folder and day-of process people wish they had the night before the call.",
    faq=[
...
KITS.append(dict(
    ...
    title="Home Caregiver Daily Report Examples (Family & Agency) 2026",
    description="Copy-ready home caregiver daily report and shift handoff examples for family caregivers and aides — meals, mood, meds, safety, when to call the doctor.",
    path="/kits/home-caregiver-daily-report-examples/",
    date="2026-07-21",
    read="10 min read",
    eyebrow="Care kit · Home care",
    h1="Home caregiver daily report examples",
    lede="Hospital SBAR is for clinical teams. At home you need a clear handoff the next person can trust: food, mood, mobility, meds given, sleep, and red flags. Here are complete examples you can copy.",
    faq=[
...
KITS.append(dict(
    ...
    title="SAP Financial Aid Appeal Letter Kit — Sample + Academic Plan (2026)",
    description="Satisfactory Academic Progress (SAP) appeal sample with the academic plan section schools actually look for. Checklist and mistakes that get denied.",
    path="/kits/sap-financial-aid-appeal-kit/",
    date="2026-07-21",
    read="10 min read",
    eyebrow="Appeal kit · Financial aid",
    h1="SAP financial aid appeal kit",
    lede="You lost aid for Satisfactory Academic Progress. Emotion alone rarely wins. Schools want: what happened, why it will not continue, and a concrete plan to get back on track.",
    faq=[
...
KITS.append(dict(
    ...
    title="Insurance Prior Authorization / Medical Necessity Appeal Kit (2026)",
    description="Sample internal appeal when insurance denies a medication or procedure as not medically necessary. Packet checklist and calm structure.",
    path="/kits/insurance-prior-auth-appeal-kit/",
    date="2026-07-21",
    read="10 min read",
    eyebrow="Appeal kit · Health insurance",
    h1="Prior auth &amp; medical necessity appeal kit",
    lede="The denial says “not medically necessary” or prior authorization was refused. You need a tight internal appeal that mirrors clinical facts — diagnosis, failed alternatives, guideline language — not a vent email.",
    faq=[
...
KITS.append(dict(
    ...
    title="Utility Shutoff Hardship Playbook — Calls, Letters, Docs (2026)",
    description="What to do with a disconnect notice: who to call, medical protection certificates, hardship letter sample, and document checklist.",
    path="/kits/utility-shutoff-hardship-playbook/",
    date="2026-07-21",
    read="9 min read",
    eyebrow="Hardship kit · Utilities",
    h1="Utility shutoff hardship playbook",
    lede="A disconnect notice is a process problem, not only a money problem. Move in this order: confirm the date, call the utility, apply for assistance, submit medical or hardship docs if you qualify, and get every promise in writing.",
    faq=[
...
KITS.append(dict(
    ...
    title="Upwork Proposal De-AI Clinic — Fix ChatGPT Drafts That Get Ignored (2026)",
    description="Side-by-side AI vs human proposal fixes, first-line rewrites, filler phrases to cut, and a send checklist. Free clinic for freelancers.",
    path="/kits/upwork-proposal-de-ai-clinic/",
    date="2026-07-21",
    read="11 min read",
    eyebrow="Freelance kit · Proposals",
    h1="Upwork proposal de-AI clinic",
    lede="Clients can smell generic ChatGPT proposals. This clinic shows exact rewrites: first lines, proof, questions, and what to delete before you spend Connects.",
    faq=[
