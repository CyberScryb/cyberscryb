...
function analyze() {
  ...
  if (COMMON_PASSWORDS.has(pw.toLowerCase()))
    warnings.push('This is a commonly used password — easily guessed');
  ...
  if (entropy < 60)
    tips.push('Try a passphrase: 4+ random words like "correct horse battery staple"');
