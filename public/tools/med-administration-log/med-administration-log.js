    ...
    function renderMAR() {
        ...
        meds.forEach(med => {
            ...
            tr.innerHTML = `
                ...
                <td><span style="color:#0066ff;">${escapeHtml(med.dosage)}</span></td>
                        ...
                        ${['Morning', 'Afternoon', 'Evening', 'Night'].map(shift => {
                            ...
                            return `
                                <label style="display: flex; flex-direction: column; align-items: center; gap: 4px; font-size: 0.7rem; color: #878787; cursor: pointer; user-select: none;">
                                    ...
                                    <span>${shift[0]}</span>
                                    <span class="time-stamp" style="font-size: 0.6rem; color: #0066ff; height: 10px; display: inline-block;">${val}</span>
                                </label>
                            `;
                        }).join('')}
                    </div>
