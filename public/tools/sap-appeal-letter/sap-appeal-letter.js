// sap-appeal-letter — CSAITool + structured life-tool UX
document.addEventListener('DOMContentLoaded', () => {
  ...
  const fieldIds = ["school", "student_id", "term", "sap_metric", "support", "next_term"];
  const modeLabels = {"gpa": "GPA shortfall", "pace": "Pace / completion rate", "max-time": "Max time frame", "combined": "Multiple SAP rules"};
