...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function calculateBaseline() {
        ...
        let alimony = (highEarnerIncome * 0.30) - (lowEarnerIncome * 0.50);
        ...
        if (state === 'Texas') {
            const cap = Math.min(5000, highEarnerIncome * 0.20);
        ...
        if (localResultEstimateEl) localResultEstimateEl.textContent = `$${Math.round(alimony).toLocaleString()}/mo`;
