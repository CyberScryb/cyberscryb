...
const { jsonToCsv, csvToJson, parseCsvLines, escapeCsvField } = require('../public/tools/json-csv-converter/script');
...
describe('parseCsvLines', () => {
    ...
    test('handles quoted fields', () => {
        ...
        expect(result).toEqual([['name', 'city'], ['Alice', 'New York']]);
    });
    ...
    test('handles commas inside quoted field', () => {
        ...
        expect(result).toEqual([['name', 'address'], ['Bob', '123 Main St, Apt 4']]);
    });
});
