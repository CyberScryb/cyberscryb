  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Local-first developer tools for free, or secure AI extensions starting at $5/month. Pricing structured with zero hidden tracking."
        />
      </Helmet>
      ...
      <div className="relative py-24 px-6 max-w-7xl mx-auto flex flex-col items-center">
        ...
        <div className="text-center max-w-3xl mb-16">
          ...
          <p className="text-lg text-muted">
            Enjoy full offline local privacy free of charge. Upgrade to support development and
            access optional AI capabilities.
          </p>
        </div>
              ...
              >
                ...
                <div>
                  <div className="flex items-center gap-3 mb-4">
                    <div
                      className={`p-2 rounded-lg bg-base border border-subtle ${tier.featured ? 'text-accent border-accent/20' : 'text-muted'}`}
                    >
                      <Icon size={18} />
                    </div>
                    <h3 className="text-xl font-mono uppercase font-bold tracking-wider text-white">
                      {tier.name}
                    </h3>
                  </div>
                  ...
                  <div className="flex items-baseline gap-1 mb-8">
                    ...
                    {tier.period && (
                      <span className="text-muted text-xs font-mono">{tier.period}</span>
                    )}
                  </div>
        ...
        <div className="mt-16 w-full max-w-4xl p-6 rounded-xl border border-subtle bg-surface/50 flex flex-col sm:flex-row items-center gap-4 text-left">
          ...
          <p className="text-xs text-muted leading-relaxed">
            <strong>Stripe Security Notice:</strong> We do not log, parse, or store payment
            credentials. Transactions are processed via Stripe checkout forms. Pro features
            authenticate using local signed cookies verified by Firebase functions.
          </p>
        </div>
      </div>
    </>
