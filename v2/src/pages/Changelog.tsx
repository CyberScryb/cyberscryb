  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Product updates, release notes, and cynical engineering rants from the creator of CyberScryb."
        />
      </Helmet>
        ...
        <div className="flex items-end justify-between mb-16 border-b border-subtle pb-8">
          <div>
            ...
            <p className="text-muted text-lg">
              Every commit, feature, and refactor. No marketing nonsense.
            </p>
          </div>
          <a
            href="/rss.xml"
            target="_blank"
            className="flex items-center gap-2 text-accent hover:text-white transition-colors pb-1"
          >
            <Rss size={16} />
            ...
            <div key={i} className="relative md:grid md:grid-cols-[160px_1fr] md:gap-8 group">
              ...
              <div className="absolute -left-[37px] md:relative md:left-0 md:flex md:justify-end mt-1.5 z-10 w-4 h-4 bg-base md:w-auto md:h-auto md:bg-transparent">
                ...
                <div className="hidden md:flex flex-col items-end">
                  ...
                  <span className="font-mono text-xs uppercase tracking-widest bg-surface border border-subtle px-2 py-0.5 rounded text-accent">
                    {update.version}
                  </span>
                </div>
              </div>
              ...
              <div className="bg-surface border border-subtle rounded-xl p-6 shadow-sm hover:border-accent/40 transition-colors relative">
                <div className="md:hidden flex items-center justify-between mb-4">
                  ...
                  <span className="font-mono text-[10px] uppercase tracking-widest bg-base border border-subtle px-2 py-0.5 rounded text-accent">
                    {update.version}
                  </span>
                </div>
                ...
                <div className="flex items-center gap-2 mb-4">
                  <span className="text-[10px] font-mono tracking-widest uppercase text-muted py-0.5 px-2 bg-base border border-strong rounded-full">
                    {update.type}
                  </span>
                </div>
